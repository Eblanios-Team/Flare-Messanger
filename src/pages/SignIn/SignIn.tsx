...
const SignIn: React.FC = () => {
	...
	const isFormValid: boolean = Boolean(
		email && login && password && !emailError && !loginError && !passwordError
	)
			...
			<div className='flex md:flex-row min-h-screen items-end'>
				...
				<div className='flex-1 flex items-end justify-center'>
					<div className='flex flex-col items-center w-full max-w-sm '>
						...
						<h2 className='text-4xl font-bold text-[#525252] mb-9 text-center'>
						...
						<form onSubmit={handleSubmit} className='flex flex-col w-full mb-40'>
							...
							<label
								htmlFor='password'
								className='flex flex-col text-sm font-semibold text-[#828282] mb-8'
							>
								Password
								<input
									type='password'
						...
						<span className='text-[#828282] text-lg font-normal text-center mb-10'>
							You have account?
							<Link to={'/login'} className='text-orange font-semibold ml-4'>
								Login an account
							</Link>
						</span>
					</div>
